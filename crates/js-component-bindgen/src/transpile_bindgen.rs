                            ...
                            TypeDefKind::Variant(_) => {
                                    ...
                                    .variant_as_direct_union_of_resource_classes()
                                {
                                        ...
                                        )
                                    {
                                        ...
                                        let variant_enum_name = format!("{variant_type_name}_type")
                                            .to_upper_camel_case();
                                        ...
                                        for type_def in &case_type_defs {
                                            ...
                                            uwriteln!(
                                                self.src.js,
                                                "
                                                    Object.defineProperty({class_name}.prototype, \"type\", {{
        ...
        match func.kind {
            ...
            FunctionKind::Method(type_id) => {
                ...
                if is_getter {
                    uwrite!(
                        self.src.js,
                        "\nObject.defineProperty({local_name}.prototype, \"{}\", {{ get: {maybe_async}function",
